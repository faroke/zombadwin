...
export function IniEditor(): JSX.Element {
    ...
    <div className="space-y-4">
      <header className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="outline" size="sm" onClick={discard} disabled={dirtyKeys.length === 0}>
            Discard
          </Button>
          <Button size="sm" onClick={submit} disabled={dirtyKeys.length === 0 || save.isPending}>
    ...
    return (
      <Card>
        <CardContent className="p-6 text-sm text-muted-foreground">
          No additional keys outside the curated schema.
        </CardContent>
      </Card>
    );
  }
